 ...
 * @Description: TODO(类说明：每日航班信息统计表; InnoDB free: 10240 kB )
 * @author ME CC 
 * @date 2018-10-28 10:54:07
 */ 
public class FFlightReportDay implements Serializable{
	private static final long serialVersionUID = 1L;
	private Integer id; 	//id
	private Integer day; 	//统计标示 哪一天
	private Integer flights; 	//航班架次
	private Integer normalFlights; 	//正常的数量
	 ...
	 * @param day	统计标示 哪一天
	 * @param flights	航班架次
	 * @param normalFlights	正常的数量
	 * @param passengers	旅客数量
	 * @param cargoWeight	货邮行重量
	 * @param rtype	统计类型1进港2出港3过站
	 * @param addTime	统计时间
	 */ 
	public FFlightReportDay(Integer id,Integer day,Integer flights,Integer normalFlights,Integer passengers,Integer cargoWeight,byte rtype,String addTime){
		this.id=id;
		this.day=day;
	...
	/**
	 * @Title:setNormalFlights 
	 * @Description: TODO(设置NormalFlights	正常的数量)
	 * @param normalFlights
	 */ 
	...
	/**
	 * @Title:setNormalFlights 
	 * @Description: TODO(得到NormalFlights	正常的数量)
	 * @return Integer
	 */ 
	...
	public String toString() { 
		return "FFlightReportDay[id=" + id + ",day=" + day + ",flights=" + flights + ","+
		"normalFlights=" + normalFlights + ",passengers=" + passengers + ",cargoWeight=" + cargoWeight + ","+
		"rtype=" + rtype + ",addTime=" + addTime + "]";
	}
}
