 ...
 * @Description: TODO(类说明：季度航班信息统计表; InnoDB free: 10240 kB )
 * @author ME CC 
 * @date 2018-10-28 10:54:07
 */ 
public class FFlightReportQuarter implements Serializable{
	 ...
	 * @param addTime	统计时间
	 */ 
	public FFlightReportQuarter(Integer id,Integer day,Integer flights,Integer passengers,Integer cargoWeight,byte rtype,String addTime){
		this.id=id;
		this.day=day;
	...
	public String toString() { 
		return "FFlightReportQuarter[id=" + id + ",day=" + day + ",flights=" + flights + ","+
